...
// +kubebuilder:validation:Enum=Restic;WalG;VolumeSnapshotter;Solr;Medusa;ClickHouseBackup;Neo4jAdmin;Weaviate;Milvus;OracleBackup
type Driver string
...
const (
	...
	DriverOracle            Driver = "OracleBackup"
	DriverNeo4jAdmin        Driver = "Neo4jAdmin"
	DriverWeaviate          Driver = "Weaviate"
	DriverMilvus            Driver = "Milvus"
)
